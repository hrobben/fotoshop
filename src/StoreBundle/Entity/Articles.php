 ...
 * @ORM\Entity(repositoryClass="StoreBundle\Repository\ArticlesRepository")
 */
class Articles
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="catagory", type="string", length=255, unique=false)
     */
    private $catagory;
     ...
     * @var string
     *
     * @ORM\Column(name="imagePath", type="string", length=255, unique=false)
     */
    private $imagePath;
